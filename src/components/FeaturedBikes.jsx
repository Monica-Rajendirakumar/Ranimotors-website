            ...
            >
              ...
              <div>
                ...
                <div className="text-left mb-4">
                  <h3 className="font-outfit text-xl sm:text-2xl md:text-3xl font-black tracking-tight text-white">
                    {bike.name}
                  </h3>
              ...
              <div>
                {/* Grid of Spec Tags */}
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-y-4 gap-x-2 border-t border-heroBorder/50 pt-6 mb-6">
