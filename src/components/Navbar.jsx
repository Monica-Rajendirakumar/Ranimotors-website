  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between">
        ...
        {/* DESKTOP MENU */}
        <div className="hidden md:flex items-center gap-10 font-outfit text-sm font-semibold tracking-widest uppercase">
          <div className="relative flex flex-col items-center">
            ...
            {location.pathname === '/' && (
              <span className="w-5 h-[2px] bg-heroRed absolute -bottom-2 rounded-full shadow-[0_0_8px_#E30613]"></span>
            )}
          </div>
          ...
          <div className="relative flex flex-col items-center">
            <Link 
              to="/bikes"
              className={`transition-colors duration-300 hover:text-heroRed uppercase ${location.pathname.startsWith('/bikes') ? 'text-heroRed' : 'text-white'}`}
            >
              Bikes
            </Link>
          ...
          <div className="relative flex flex-col items-center">
            <Link 
              to="/about" 
              className={`transition-colors duration-300 hover:text-heroRed uppercase ${location.pathname === '/about' ? 'text-heroRed' : 'text-white'}`}
            >
              About Us
            </Link>
            {location.pathname === '/about' && (
              <span className="w-8 h-[2px] bg-heroRed absolute -bottom-2 rounded-full shadow-[0_0_8px_#E30613]"></span>
            )}
          </div>
          ...
          <div className="relative flex flex-col items-center">
            <Link 
              to="/offers" 
              className={`transition-colors duration-300 hover:text-heroRed uppercase ${location.pathname === '/offers' ? 'text-heroRed' : 'text-white'}`}
            >
              Offers
            </Link>
