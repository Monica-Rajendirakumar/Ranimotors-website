...
export default function Hero() {
  ...
  return (
    <>
      <section className="relative min-h-[100dvh] bg-heroDark flex items-center justify-between overflow-hidden pt-24 pb-12 lg:pt-20 lg:pb-0 px-4 md:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full items-center z-10 py-12">
          ...
          <div className="lg:col-span-6 flex flex-col text-left space-y-6">
            ...
            >
              ...
              <h1 className="font-outfit text-5xl sm:text-6xl md:text-8xl font-black italic tracking-tighter leading-none text-white select-none">
                RANI <br />
            ...
            >
              <button
                ...
                className="bg-heroRed hover:bg-red-700 text-white font-outfit text-sm font-bold tracking-widest uppercase px-8 py-4 rounded-sm flex items-center justify-center gap-2 shadow-red-glow hover:shadow-red-glow-strong hover:-translate-y-0.5 transition-all duration-300 w-full sm:w-auto"
              >
                Explore Bikes
              ...
              <button
                ...
                className="border border-white/20 hover:border-white/50 hover:bg-white/5 text-white font-outfit text-sm font-bold tracking-widest uppercase px-8 py-4 rounded-sm flex items-center justify-center gap-2 hover:-translate-y-0.5 transition-all duration-300 w-full sm:w-auto"
              >
                Our Showroom
