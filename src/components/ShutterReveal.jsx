...
export default function ShutterReveal() {
  ...
  return (
    <div 
      id="shutter-reveal" 
      ref={containerRef} 
      className="relative min-h-[100dvh] lg:h-screen w-full overflow-hidden bg-black select-none border-t border-heroBorder/30 py-16 lg:py-0 flex items-center"
    >
      {/* SHOWROOM CONTAINER */}
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 w-full h-full flex flex-col lg:flex-row items-center justify-between z-20 relative">
          ...
          <div ref={textRef} className="text-left flex flex-col space-y-4 lg:max-w-md pt-12 lg:pt-0">
            ...
            <div className="space-y-1">
              <h2 className="font-outfit text-xl sm:text-2xl md:text-3xl font-extrabold uppercase tracking-wide text-white">
                BUILT FOR
              </h2>
              <h3 className="font-outfit text-3xl sm:text-4xl md:text-5xl font-black italic tracking-tight text-heroRed">
                EVERY TERRAIN.
              </h3>
              <h1 className="font-outfit text-4xl sm:text-5xl md:text-6xl font-black uppercase tracking-tighter text-white">
                XPULSE 210
              </h1>
            </div>
