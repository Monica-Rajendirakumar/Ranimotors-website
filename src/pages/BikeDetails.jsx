          ...
          <div className="lg:col-span-6 flex flex-col text-left space-y-6">
            ...
            <div className="flex border-b border-heroBorder">
              <button
                ...
                className={`font-outfit text-xs sm:text-sm font-bold tracking-wide sm:tracking-widest uppercase pb-3 border-b-2 px-3 sm:px-6 transition-all duration-300 ${
                  activeTab === 'specs'
